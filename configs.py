...
class Config(object):
    ...
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5816259179:AAHzkTbyZpbpPE_GYCv5AMPQC4fhl96AhgI")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "VivdiskSearchetBott")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "String")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001836111440")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "VivdiskSearchetBot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "1963114305"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Md_Matin_Ashraf")
...
Jᴜsᴛ Tʏᴘᴇ ᴀ Mᴏᴠɪᴇ Nᴀᴍᴇ 🎬**""" ) 
    START_PHOTO = os.getenv("START_PHOTO", "https://telegra.ph/file/7bdda23cd8599e3991107.jpg")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    ...
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Matin:HnEms92DZC02pv3S@cluster0.ygefm.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001865931579"))
